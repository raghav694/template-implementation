...
class _ConfigApiService implements ConfigApiService {
  ...
  @override
  Future<AppConfigStatus> getStatus() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AppConfigStatus>(
    ...
    late AppConfigStatus _value;
    try {
      _value = AppConfigStatus.fromJson(_result.data!);
    } on Object catch (e, s) {
