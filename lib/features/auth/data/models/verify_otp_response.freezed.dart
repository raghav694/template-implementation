...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyOtpResponse&&(identical(other.user, user) || other.user == user)&&(identical(other.tokens, tokens) || other.tokens == tokens));
}
...
@override
String toString() {
  return 'VerifyOtpResponse(user: $user, tokens: $tokens)';
}
...
class _VerifyOtpResponse extends VerifyOtpResponse {
  const _VerifyOtpResponse({required this.user, this.tokens = const AuthTokens()}): super._();
  

@override final  UserModel user;
@override@JsonKey() final  AuthTokens tokens;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VerifyOtpResponse&&(identical(other.user, user) || other.user == user)&&(identical(other.tokens, tokens) || other.tokens == tokens));
}
